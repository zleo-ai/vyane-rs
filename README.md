...
Native AgentRun permissions remain explicit request opt-ins. Optional
`[native_permissions]` sections in user, project, explicit, and
operator-managed config files only impose independent ceilings; see
[WP-88](docs/plan/WP-88.md).
