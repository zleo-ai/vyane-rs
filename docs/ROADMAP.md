...
| milestone | scope |
|-----------|-------|
| ~~**workflow engine**~~ | ✅ declarative DAG pipelines with target/fan-out steps, template data flow, journal and resume. |
