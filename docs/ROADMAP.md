...
load.
[WP-128](plan/WP-128.md) isolates expired-controller restart settlement in a
fresh CI process after suite load still observed `running` instead of
`timed_out` while the body stayed stable alone.
