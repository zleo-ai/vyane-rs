...
atomic redacted snapshot. General goal reads, mutation authority, WP-81 typed
observation ingestion and the separately authenticated WP-82 runner remain
open.
